...
(1, 'Men Suits', 'Men Suits', NULL, 'Men Suits.jpg'),
(2, 'Suits', 'Suits', NULL, 'Suits.jpg'),
(3, 'Dresses', 'Dresses', NULL, 'Dresses.jpg'),
(4, 'Saree', 'Saree', NULL, 'Saree.jpg'),
(5, 'Bottom', 'Bottom', NULL, 'Bottom.jpg'),
(6, 'Lehnga', 'Lehnga', NULL, 'lehnga.jpg');
...
(1, 'Frock Suit', '2', 'Frock Suits.jpg', 'Fashion is a form of self-expression and autonomy at a particular period and place and in a specific context, of clothing, footwear, lifestyle, accessories, makeup, hairstyle, and body posture. The term implies a look defined by the fashion industry as that which is trending.\n', NULL, '10000', NULL),
(4, 'Red Kurti', '3', 'Red Kurti.jpg', 'Fashion is a form of self-expression and autonomy at a particular period and place and in a specific context, of clothing, footwear, lifestyle, accessories, makeup, hairstyle, and body posture. The term implies a look defined by the fashion industry as that which is trending.\n', NULL, '9000', NULL),
(5, 'Denim Jeans', '2', 'Denim.jpg', 'Fashion is a form of self-expression and autonomy at a particular period and place and in a specific context, of clothing, footwear, lifestyle, accessories, makeup, hairstyle, and body posture. The term implies a look defined by the fashion industry as that which is trending.\n', NULL, '8000', NULL),
...
(7, 'Color T-Shirt', '3', 'Color T-Shirt.jpg', 'Fashion is a form of self-expression and autonomy at a particular period and place and in a specific context, of clothing, footwear, lifestyle, accessories, makeup, hairstyle, and body posture. The term implies a look defined by the fashion industry as that which is trending.\n', NULL, '12000', NULL),
(9, 'Rajwadi Lehnga', '6', 'Rajwadi Lehnga.jpg', 'Fashion is a form of self-expression and autonomy at a particular period and place and in a specific context, of clothing, footwear, lifestyle, accessories, makeup, hairstyle, and body posture. The term implies a look defined by the fashion industry as that which is trending.\n', NULL, '30000', NULL),
(10, 'Full Suit', '1', 'Full Suits.jpg', 'Fashion is a form of self-expression and autonomy at a particular period and place and in a specific context, of clothing, footwear, lifestyle, accessories, makeup, hairstyle, and body posture. The term implies a look defined by the fashion industry as that which is trending.\n', NULL, '8000', NULL),
